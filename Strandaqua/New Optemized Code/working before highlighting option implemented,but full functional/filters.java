...
function fil ()
{
    ...
    //
    // &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='checkbox' onclick='parent.page()' name='high' value='1'>
...
function page ()
{
	...
	if (evnt [ent] == true)
	{
		...
		while (parent.loc [epos] == ent)
		{
		    ...
		    {
			tmpres += "<div style='border-bottom-style: solid; border-bottom-width: 1px; padding-bottom: 1px'><p align='center'><b>" + parent.type [parent.loc [epos + 1]] + "</b></div></p>" + result2 (pos, parent.loc [epos + 2], 0);
		    }
...
function result2 (pos, num, e)
{
	...
	//{
	// if (parent.h.document.F.high.checked == true)
	// {
...
{
    LoadWin = null;
    loadWin (10, 10, 420, 500, "Swimmer Results", true);
	...
	{
	    LoadWin.document.write ("<tr><td width ='50px' align ='center'>" + parent.events [ares [ath] [q] + 1] + "</td><td width ='50px'>" + parent.events [ares [ath] [q] + 4] + "m</td><td width ='60px'>" + parent.type [ares [ath] [q + 2]] + "</td><td width ='40px'>" + parent.res [ares [ath] [q + 1]] + "</td><td width ='80px'>" + parent.res [ares [ath] [q + 1] + 2] + "</td><td>" + age (parent.events [ares [ath] [q] + 3]) + "</td></tr>");
