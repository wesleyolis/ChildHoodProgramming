...
public class WebResults
{
    ...
    private Vector Athletes = new Vector (300, 25), Clubs = new Vector (30, 3), Events = new Vector (80, 10), Type = new Vector (2, 1), Results = new Vector (300, 100);
    ...
    void ValidateDatabase () throws SQLException  //Cheaks the database data that it does not contain any miss match data
    {
	...
	{
	    DataRequest = DataBase.createStatement ();
	    meetsres = DataRequest.executeQuery ("SELECT MEET.Meet, MEET.MName, MEET.Course, MEET.Start, MEET.End, MEET.Location, MEET.Meet FROM MEET WHERE (((Meet.Start)<Date())And ((Meet.Start)>(Date()-900))) ORDER BY MEET.Start DESC;");
	}
