...
function page ()
{
    ...
    loadWin ();
    events2 ();
    resWin ("Proccessing Filter", "Always more advanced");
    window.status = "begin";
    t = new Date; //timer start
    parent.m.document.clear ();
    parent.m.document.write ("<html><head><Title>Results</Title><style><!--a{text-decoration:none;color:#000000;}a:hover{color:#FFFFFF;}--></style></head><body background='../images/back.jpg' style='background-attachment:fixed' topmargin='0' leftmargin='0'><tableborder='0'width='600'cellspacing='0'cellpadding='0'><tr><tdalign='left'>");

    i = 0;
    for (; i < res.length - 99 ; i += 99)
    {
...
function pro ()
{
	...
	if ((prepos + 102) < resok ())
	{
	    parent.m.document.write (result2 (prepos, 33, 0));
	    prepos += 99;
	}
	else
	{
...
function prefin ()
{
	...
	time++;
	parent.m.document.write (result2 (a, 33, 0));
    }


    parent.m.document.write (result2 (a, 18, 0));
    parent.m.document.write ("</td></tr><t/able></body></html>");
    parent.m.document.close ();
    parent.m.focus ();
    t2 = new Date;
...
function events2 ()
{
    ...
    b = b + "</p></td></tr><tr><td width='15'><img alt='' src='images/MsoPnl_Cnr_bl_104C1.gif' width='15' height='19'></td><td nowrap bgcolor='#003399' width='426'><a herf='' onclick=\"document.all.Events.style.pixelLeft='-510'\"><b><font color='#FFFFFF'>" + size ("", 32) + "Click here on bar to close" + size ("", 32) + "</font></b></a></td><td height='19' width='15'><img alt='' src='images/MsoPnl_Cnr_br_104C3.gif' width='15' height='19'></td></tr></table></td><td height='200' width='5'><img alt='' width='5' height='100%' src='images/MsoPnl_sh_b_104BC.gif'></td></tr><tr><td colspan='2' height='5'><img alt='' width='460' height='5' src='images/MsoPnl_sh_r_104BB.gif'></td></tr></table></div>"
	parent.m.document.write (b);
}
...
function resWin (d, s)
{
    ...
    LoadWin.document.write ("<p align='center'><font size='5'>" + d + "<\/font><\/p><p align='center'><form name = 'per'>*&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='p' size='1' style='font-size: 16pt; font-weight: bold; border-style: solid; border-width: 0; padding: 0; background-color:#0066CC'>*</form></p><p align='center'><font size='5'>" + s + "<\/font><\/p><body><html>");
