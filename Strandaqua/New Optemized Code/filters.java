...
function page ()
{
    ...
    parent.m.document.close ();
    parent.m.focus ();
    window.status = "Proccesing Finshed";
    t2 = new Date;
    ...
    window.status = "Processing Finshed in " + ss + " Seconds & " + mm + " Milli-Seconds, of " + total + " results";
...
function loadWin (w, h, t)
{
    LoadWin = window.open ("", "", "width=" + w + ",height=" + h + ",Left=" + ((screen.Width / 2) - 125) + ",Top=" + ((screen.Height / 2) - 75));
    LoadWin.document.write ("<html><head><Title>" + t + "</Title></head><body background='../images/back.jpg' bgColor='#0066CC' topmargin='0' leftmargin='0'><body><html>");
}
function resWin (d, s)
{
